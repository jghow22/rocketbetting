    ...
    try:
        ...
        if ai_raw.get("error"):
            ...
            fallback = {
                ...
                "confidence": 65,
                "risk_level": "Medium",
                "analysis": "AI service unavailable, autogenerated 2-leg parlay including the selected matchup."
            }
            game_parlay_cache[cache_key] = fallback
            return {"game_parlay": fallback}
